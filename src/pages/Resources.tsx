...
const Resources = () => {
  const faqs = [
    {
      question: "How can I advocate for myself during prenatal appointments?",
    ...
    {
      question: "How do I find a midwife who understands Indigenous culture?",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-large text-black max-w-3xl mx-auto italic">
              Empowering you with knowledge, connections, and tools to advocate for 
              the care you and your baby deserve.
            </p>
          </div>
          ...
          <section className="mb-16">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="text-left font-serif font-semibold text-lg text-black hover:text-gray-700">
                    {faq.question}
                  </AccordionTrigger>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {resources.map((resource, index) => (
                <Card key={index} className="bg-white/60 backdrop-blur-sm border-border/50 hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="font-serif text-lg text-black">{resource.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-black text-body mb-4 italic">{resource.description}</p>
          ...
          <section className="mb-16">
            <Card className="bg-white/60 backdrop-blur-sm border-border/50">
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-serif font-semibold text-black text-lg mb-4">Before Appointments:</h3>
                    <ul className="space-y-2 text-black text-body">
                      <li>• Write down your questions and concerns</li>
                      <li>• Bring a support person <span className="italic">if desired</span></li>
                      <li>• Research your healthcare provider</li>
                      <li>• Prepare your medical history</li>
                      <li>• Know your rights and options</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="font-serif font-semibold text-black text-lg mb-4">During Appointments:</h3>
                    <ul className="space-y-2 text-black text-body">
                      <li>• Ask questions if you don't understand</li>
                      <li>• Request time to consider options</li>
                      <li>• Discuss cultural preferences</li>
                      <li>• Take notes <span className="italic">or ask for written information</span></li>
                      <li>• Trust your instincts and speak up</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <div>
                    ...
                    <h3 className="font-serif font-semibold text-black text-base mb-2">24/7 Crisis Line</h3>
                    <p className="text-black text-body">1-888-472-4367</p>
                  </div>
                  <div>
                    <Mail className="h-8 w-8 mx-auto mb-2 text-primary" />
                    <h3 className="font-serif font-semibold text-black text-base mb-2">Patient Advocate</h3>
                    <p className="text-black text-body italic">advocate@bqfn.ca</p>
                  </div>
                  <div>
                    <MapPin className="h-8 w-8 mx-auto mb-2 text-primary" />
                    <h3 className="font-serif font-semibold text-black text-base mb-2">Health Centre</h3>
                    <p className="text-black text-body">Bay of Quinte First Nations</p>
                  </div>
                </div>
              </CardContent>
            </Card>
